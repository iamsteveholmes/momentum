...
- **FR82:** Developer can invoke `/momentum:epic-grooming` to analyze the epic taxonomy holistically — identifying orphaned slugs, overlapping categories, and misclassified stories — and apply approved taxonomy changes via momentum-tools. **Priority: Medium**
...
- **FR83:** Developer can invoke `/momentum:refine` to run backlog refinement — parallel PRD and architecture gap discovery, priority suggestions, stale story detection, and dependency analysis — with approved changes applied via momentum-tools CLI. **Priority: Medium**
