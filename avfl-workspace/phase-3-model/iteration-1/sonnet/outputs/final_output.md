...
Transformation applies an exponential backoff retry policy (up to 3 attempts with increasing delay) on transient failures.
...
Security considerations are out of scope for this architecture brief and will be addressed in a separate security design document.
