...
The full treatment of Momentum's ten principles, the quality model, and the research foundation behind the practice. For the practice itself — the cycle, the skills, and the enforcement machinery — see the [README](../README.md).
...
- [Solo Agentic Engineering: Process, Philosophy, and Implementation Plan](planning-artifacts/AI-Solo-Dev-Workflow-Plan-2026-03-07-final.md)
...
- [Agentic Architecture: BMAD vs Claude Code Native](research/technical-agentic-architecture-bmad-vs-claude-code-2026-03-07.md) — tradeoffs between framework-managed and native agent patterns
- [Claude Code Tool Permissions](research/technical-claude-code-tool-permissions-research-2026-03-07.md) — permission model for agent tool access
- [Subagent Permissions Reference](research/technical-subagent-permissions-reference-2026-03-07.md) — schema for sub-agent capability constraints
